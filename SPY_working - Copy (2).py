...
def show_price_chart(file_path, start_date, end_date):
    ...
    try:
        ...
        def show_detailed_trades():
            ...
            header = f"{'Action':<15} {'Date':<12} {'Price':>10} {'Short MA':>12} {'Long MA':>12} {'Comments':<25}"
            ...
            for i, trade in enumerate(all_trades):
                ...
                # Format aligned row with Comments
                row_text = f"{action:<15} {date.strftime('%Y-%m-%d'):<12} {price:>10.2f} {short_ma_str:>12} {long_ma_str:>12} {position_info:<25}"
                if action == "Buy":
