...
def show_price_chart(file_path, start_date, end_date):
    ...
    try:
        ...
        def show_detailed_trades():
                ...
                header = f"{'Action':<15} {'Date':<12} {'Price':>10} {'Gain%':>8} {'Prev Short MA':>14} {'Short MA':>12} {'Prev Long MA':>14} {'Long MA':>12} {'Short MA Slope':>14} {'Long MA Slope':>14} {'Comments':<25}"
                ...
                for i, trade in enumerate(all_trades):
                    ...
                    # Format aligned row with Comments, previous MA columns, and both Slope columns
                    row_text = f"{action:<15} {date.strftime('%Y-%m-%d'):<12} {price:>10.2f} {gain_str:>8} {prev_short_ma_str:>14} {short_ma_str:>12} {prev_long_ma_str:>14} {long_ma_str:>12} {short_slope_str:>14} {long_slope_str:>14} {position_info:<25}"
                    if action == "Buy":
                ...
                # After all trades, if a position is open, add a simulated closing trade row
                if position != 0:
                    ...
                    if position == 1:
                        ...
                        tag = "cover"
                        position_info = "(Simulated closing trade)"
                    # Use same alignment as other rows
                    row_text = f"{action:<15} {final_date.strftime('%Y-%m-%d'):<12} {final_price:>10.2f} {prev_short_ma_str:>14} {short_ma_str:>12} {prev_long_ma_str:>14} {long_ma_str:>12} {short_slope_str:>14} {long_slope_str:>14} {position_info:<25}"
                    trades_detail.insert(tk.END, row_text + "\n", tag)
