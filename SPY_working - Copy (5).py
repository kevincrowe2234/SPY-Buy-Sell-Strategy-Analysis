...
def show_price_chart(file_path, start_date, end_date):
    ...
    try:
        ...
        def show_detailed_trades():
            ...
            header = f"{'Action':<15} {'Date':<12} {'Price':>10} {'Prev Short MA':>14} {'Short MA':>12} {'Prev Long MA':>14} {'Long MA':>12} {'Short MA Slope':>14} {'Long MA Slope':>14} {'Comments':<25}"
            ...
            for i, trade in enumerate(all_trades):
                ...
                row_text = f"{action:<15} {date.strftime('%Y-%m-%d'):<12} {price:>10.2f} {prev_short_ma_str:>14} {short_ma_str:>12} {prev_long_ma_str:>14} {long_ma_str:>12} {short_slope_str:>14} {long_slope_str:>14} {position_info:<25}"
                if action == "Buy":
            ...
            if position != 0:
                ...
                if idx and idx[0] > 0:
                    ...
                    prev_short_ma = float('nan')
                    prev_long_ma = float('nan')
                if 'include_slope_check_var' in globals() and include_slope_check_var.get():
