...
def show_price_chart(file_path, start_date, end_date):
    ...
    try:
        ...
        def show_detailed_trades():
            ...
            # Add column headers
            trades_detail.insert(tk.END, "Action          Date            Price      \n")
            ...
            # Add a header explaining the trade pairs
            trades_detail.insert(tk.END, "Note: Trades typically occur in pairs:\n", "note")
            ...
            for i, trade in enumerate(all_trades):
                ...
                if action == "Buy":
                    ...
                    trades_detail.insert(tk.END, f"{action:<15} {date.strftime('%Y-%m-%d'):<15} ${price:.2f} {position_info}\n", "buy")
                elif action == "Sell":
                    position = 0
